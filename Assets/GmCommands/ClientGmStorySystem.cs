    ...
    public sealed class ClientGmStorySystem
    {
        ...
        public void Init()
        {
            try {
				...
				StoryCommandManager.Instance.RegisterCommandFactory(StoryCommandGroupDefine.GM, "listensocket", "listensocket(port) command", new StoryCommandFactoryHelper<ListenSocketCommand>());
                ...
                StoryFunctionManager.Instance.RegisterFunctionFactory(StoryFunctionGroupDefine.GM, "getobjectmemory", "getobjectmemory(obj) function, get object memory", new StoryFunctionFactoryHelper<GetObjectMemoryFunction>());
